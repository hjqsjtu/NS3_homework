...
public:
  ...
  Sender();
  virtual ~Sender();
  void SetLastTracker (Ptr<TimeMinMaxAvgTotalCalculator> xlast);
protected:
...
private:
  ...
  Ptr<TimeMinMaxAvgTotalCalculator> m_last;
...
public:
  ...
  void SetJitterTracker (Ptr<MinMaxAvgTotalCalculator<double>> jitter);
  //void SetDelayJitterTracker (Ptr<DelayJitterEstimation> delayJitter);
protected:
  virtual void DoDispose (void);
...
private:
  ...
  Ptr<MinMaxAvgTotalCalculator<double>> m_jitter;
  Time m_previousRx;   //!< Previous Rx time
  Time m_previousRxTx; //!< Previous Rx or Tx time
  //double m_jitter; //!< Jitter estimation
  //Ptr<DelayJitterEstimation> m_delayJitter;
  // end class Receiver
};
